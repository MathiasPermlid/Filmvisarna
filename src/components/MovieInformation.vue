    ...
    <div class="mobile-movie-bg col-12 pl-0 pr-0 pb-0">
        <picture class="img-fluid">
            ...
            <div class="dropdown show col-12 adjust-div hide-on-desktop">
                <button class="button dropdown-toggle text-white btn-brass adjust-btn mr-4" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Boka
  </button>

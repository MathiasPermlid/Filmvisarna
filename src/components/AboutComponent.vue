...
<div class="container row m-0 p-0">
    ...
    <article class="mobile-p mt-3 ml-3 mr-3">
        <p class="mobile-p">Grand är Malmös mest anrika bio med fullständiga rättigheter, säten av mjuk sammet och inga dumma inloggningar <i>- som på den goda tiden.</i></p>
